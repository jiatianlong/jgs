...
@RestController
@RequestMapping("/wxpaycs")
public class WxZhiController {


    //支付成功后的回调函数
    public static String wxnotify = "http://192.168.0.102:8088/wxpaycs/wxNotifySignContract";
    ...
    public JTLJSONResult wxPeiOrderPay(@RequestBody WithOrder withOrder){
        ...
        //回调方法 待测试
        parameters.put("notify_url", wxnotify);
        ...
        System.out.println(payReq.getAppId()+","+payReq.getPartnerId()+","+payReq.getPrepayId());
        //创建配单信息
